...
namespace schnek {
  ...
  class LiteratureReference {
    ...
    std::string address;    //  Publisher's address (usually just the city, but can be the full address for lesser-known
                            //  publishers)
    ...
    std::string key;    // A hidden field used for specifying or overriding the alphabetical order of entries (when the
                        // "author" and "editor" fields are missing). Note that this is very different from the citation
                        // key that is used to cite or cross-reference the entry.
    ...
    std::string number;        // The "(issue) number" of a journal, magazine, or tech-report, if applicable. (Most
    ...
    std::string series;  // The series of books the book was published in (e.g. "The Hardy Boys" or "Lecture Notes in
                         // Computer Science")
    std::string title;   // The title of the work
    std::string type;    // The field overriding the default type of publication (e.g. "Research Note" for techreport,
    ...
    PublicationType getPublicationType() const { return publType; }

    std::string getAddress() const { return address; }

    std::string getAnnote() const { return annote; }

    std::string getAuthor() const { return author; }

    std::string getBooktitle() const { return booktitle; }

    std::string getChapter() const { return chapter; }

    std::string getCrossref() const { return crossref; }

    std::string getEdition() const { return edition; }

    std::string getEditor() const { return editor; }

    std::string getEprint() const { return eprint; }

    std::string getHowpublished() const { return howpublished; }
    ...
    std::string getPages() const { return pages; }
    ...
    virtual std::string getBibKey() const { return bibKey; }

    void setPublicationType(PublicationType publType) { this->publType = publType; }

    void setAddress(std::string address) { this->address = address; }

    void setAnnote(std::string annote) { this->annote = annote; }

    void setAuthor(std::string author) { this->author = author; }

    void setBooktitle(std::string booktitle) { this->booktitle = booktitle; }

    void setChapter(std::string chapter) { this->chapter = chapter; }

    void setCrossref(std::string crossref) { this->crossref = crossref; }

    void setEdition(std::string edition) { this->edition = edition; }

    void setEditor(std::string editor) { this->editor = editor; }

    void setEprint(std::string eprint) { this->eprint = eprint; }

    void setHowpublished(std::string howpublished) { this->howpublished = howpublished; }

    void setInstitution(std::string institution) { this->institution = institution; }

    void setJournal(std::string journal) { this->journal = journal; }
    ...
    void setPages(std::string pages) { this->pages = pages; }
    ...
    void setDoi(std::string doi) { this->doi = doi; }

    void setVolume(std::string volume) { this->volume = volume; }
  ...
  class LiteratureArticle : public LiteratureReference {
      public:
    LiteratureArticle(
        std::string bibKey, std::string author, std::string title, std::string journal, std::string year,
  ...
  class LiteratureBook : public LiteratureReference {
      public:
    LiteratureBook(
        std::string bibKey, std::string author, std::string editor, std::string title, std::string publisher,
        std::string year, std::string volume = "", std::string number = "", std::string series = "",
  ...
  class LiteratureBooklet : public LiteratureReference {
      public:
    LiteratureBooklet(
        std::string bibKey, std::string title, std::string author = "", std::string howpublished = "",
        std::string address = "", std::string month = "", std::string year = "", std::string note = "",
        std::string key = ""
    )
        : LiteratureReference(bibKey) {
  ...
  class LiteratureInBook : public LiteratureReference {
      public:
    LiteratureInBook(
        std::string bibKey, std::string author, std::string editor, std::string title, std::string chapter,
        std::string pages, std::string publisher, std::string year, std::string volume = "", std::string number = "",
        std::string series = "", std::string type = "", std::string address = "", std::string edition = "",
        std::string month = "", std::string note = "", std::string key = ""
    )
        : LiteratureReference(bibKey) {
  ...
  class LiteratureInCollection : public LiteratureReference {
      public:
    LiteratureInCollection(
        std::string bibKey, std::string author, std::string title, std::string booktitle, std::string publisher,
        std::string year, std::string editor = "", std::string volume = "", std::string number = "",
        std::string series = "", std::string type = "", std::string chapter = "", std::string pages = "",
        std::string address = "", std::string edition = "", std::string month = "", std::string note = "",
        std::string key = ""
    )
        : LiteratureReference(bibKey) {
  ...
  class LiteratureInProceedings : public LiteratureReference {
      public:
    LiteratureInProceedings(
        std::string bibKey, std::string author, std::string title, std::string booktitle, std::string year,
  ...
  class LiteratureManual : public LiteratureReference {
      public:
    LiteratureManual(
        std::string bibKey, std::string title, std::string author = "", std::string organization = "",
        std::string address = "", std::string edition = "", std::string year = "", std::string publisher = "",
        std::string note = "", std::string key = ""
    )
        : LiteratureReference(bibKey) {
  ...
  class LiteratureMastersThesis : public LiteratureReference {
      public:
    LiteratureMastersThesis(
        std::string bibKey, std::string author, std::string title, std::string school, std::string year,
        std::string type = "", std::string address = "", std::string month = "", std::string note = "",
        std::string key = ""
    )
        : LiteratureReference(bibKey) {
  ...
  class LiteratureMisc : public LiteratureReference {
      public:
    LiteratureMisc(
        std::string bibKey, std::string author, std::string title, std::string howpublished = "",
  ...
  class LiteratureProceedings : public LiteratureReference {
    ...
    LiteratureProceedings(
        std::string bibKey, std::string title, std::string year, std::string editor = "", std::string volume = "",
        std::string number = "", std::string series = "", std::string address = "", std::string month = "",
        std::string organization = "", std::string publisher = "", std::string note = "", std::string key = ""
    )
        : LiteratureReference(bibKey) {
  ...
  class LiteratureTechReport : public LiteratureReference {
      public:
    LiteratureTechReport(
        std::string bibKey, std::string author, std::string title, std::string institution, std::string year,
  ...
  class LiteratureUnpublished : public LiteratureReference {
    ...
    LiteratureUnpublished(
        std::string bibKey, std::string author, std::string title, std::string note, std::string year,
