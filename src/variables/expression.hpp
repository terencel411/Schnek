...
namespace schnek {
  ...
  class FunctionNotFoundException : public EvaluationException {
    public:
      FunctionNotFoundException(std::string functionName)
          : EvaluationException("Function '" + functionName + "' was not defined!") {}
  };
  ...
  struct ExpressionEvaluator : public boost::static_visitor<ResultVariant> {
      ...
      ResultVariant operator()(ExpressionPointer e) {
        return e->eval();
      }
  };
  ...
  class UnaryOp : public Expression<vtype> {
    ...
    public:
      ...
      DependencyList getDependencies() { return expr->getDependencies(); }
  };
    ...
    public:
      ...
      vtype eval() {
        ...
        while (++it != expressions.end()) {
          ...
          val = it->positive ? opPositive::eval(val, it->expression->eval())
                             : opNegative::eval(val, it->expression->eval());
  ...
  struct StaticCast {
    public:
      ...
      vtype operator()(const atype &a) {
        return static_cast<vtype>(a);
      }
  };
  ...
  struct DependenciesGetter : public boost::static_visitor<DependencyList> {
      template<class ExpressionPointer>
      DependencyList operator()(ExpressionPointer e) {
