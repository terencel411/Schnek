...
namespace schnek {
  ...
  namespace internal {
    ...
    SCHNEK_INLINE GridBase<T, rank, CheckingPolicy, StoragePolicy>& GridBase<
        T, rank, CheckingPolicy, StoragePolicy>::operator-=(GridBase<T2, rank, CheckingPolicy2, StoragePolicy>& grid) {
      typedef typename StoragePolicy::storage_iterator Iterator;
      Iterator dest = this->begin();
    ...
    SCHNEK_INLINE GridBase<T, rank, CheckingPolicy, StoragePolicy>& GridBase<
        T, rank, CheckingPolicy, StoragePolicy>::operator-=(GridBase<T2, rank, CheckingPolicy2, StoragePolicy2>& grid) {
